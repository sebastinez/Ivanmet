...
<form action="./api_images/api_images.php" method="POST" enctype="multipart/form-data">
...
<div class='col-xs-12 col-md-6 col-lg-4'>
  ...
  <img src='../expertise_imagenes_2/<?php echo $key; ?>.jpg' alt="<?php echo $value; ?>" class="p-4" style="width:100%;">
...
<div class="modal fade" id="editar_<?php echo $key; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="./api_images/api_images.php" method="POST">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <img src="../expertise_imagenes_2/<?php echo $key; ?>.jpg" width="100%" style="margin-top:15px;">
      </div>
      <div class="modal-footer">
        <form action="./api_images/api_images.php" method="POST">
        <input type="hidden" value="<?php echo $key; ?>" name="hash">
