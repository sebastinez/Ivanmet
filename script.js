...
function showTextOnClick() {
  ...
  var text_en =
    "<ul id='herramientas_mobile'><a href='?page=noticia#text'><li class='herrItem'>News</li></a><a href='?page=cotizador#text'><li class='herrItem'>Currency Converter</li></a><a href='?page=dimensiones#text'><li class='herrItem'>Unit Converter</li></a><a href='?page=horarios#text'><li class='herrItem'>World Time</li></a><a href='/pages/TablaIncoterms.pdf' target='_blank'><li class='herrItem'>INCOTERMS</li></a><a href='/pages/Container.pdf' target='_blank'><li class='herrItem'>Shipping Container</li></a></ul>";
