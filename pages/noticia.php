  ...
  <div class="body-container-text">
    ...
    if (!empty($rss_feed)) {
      ...
      foreach ($rss_feed->channel->item as $feed_item) {
        ...
        <a href="<?php echo $feed_item->link; ?>">
          <div class="newsBox">
            <div>
              <div>
                <h2 style="color:black;"><?php echo $feed_item->title; ?></h2>
              </div>
              <div style="margin-top:10px; margin-bottom:10px;"><?php echo date("d/m/Y", strtotime($feed_item->pubDate)); ?></div>
            </div>
      ...
      <?php
        ...
        ?><div class="newsBox">
        <h2>No se pudo establecer la conexion, intente mas tarde por favor</h2>
      </div><?php
            }
            ?>
